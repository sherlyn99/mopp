    ...
    for identifier, omic_dict in md_dict.items():
        for omic in omic_dict.keys():
            ...
            if omic == "metaRS":
                ...
                arg_list_renamefiles.append((outdir_trimmed, outdir_cat, identifier, omic, r1_stem))
            else:
                ...
                arg_list_catpaired.append((outdir_trimmed, outdir_cat, identifier, omic, r2_stem))
